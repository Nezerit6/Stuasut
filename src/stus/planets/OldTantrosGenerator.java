...
public class OldTantrosGenerator extends PlanetGenerator{
    ...
    public void genTile(Vec3 position, TileGen tile){
        ...
        if(Ridged.noise3d(seed + 2, position.x, position.y, position.z, 2, 22) > 0.31){
